...
class Ion_auth_model extends CI_Model
{
	...
	public function forgotten_password($email = '')
	{
		...
		if (filter_var($user_meta->email, FILTER_VALIDATE_EMAIL)) {
	 ...
	 *
	 * @return object
	 * @author Rajat Yadav and Kamal Yadav
	 **/
	public function get_user_preview($id = null)
	{
		// Don't grab the user data again if we
		// already have it
		if (is_numeric($id) and isset($this->users[$id]))
