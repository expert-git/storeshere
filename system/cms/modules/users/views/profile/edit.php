...
<style type="text/css">
fieldset legend {color: #fff; font-size: 16px;}
ul {list-style: none; color: #fff;}
ul li {color: #fff; padding: 4px;}
ul li label {}
ul li .input {margin : 10px 0 5px 1px;}
input {background: #ffffff none repeat scroll 0 0;border: 0 none;border-radius: 0;height: 24px;padding: 0 5px;}
</style>