...
<html>
    <head>
        ...
        <title>Storeshere - Image Editor</title>
        <style type="text/css">[ng-cloak]#splash{display:block!important}[ng-cloak]{display:none}#splash{display:none;position:absolute;top:45%;left:50%;width:6em;height:6em;overflow:hidden;border-radius:100%;z-index:0}@-webkit-keyframes fade{from{opacity:1}to{opacity:.2}}@keyframes fade{from{opacity:1}to{opacity:.2}}@-webkit-keyframes rotate{from{-webkit-transform:rotate(0deg)}to{-webkit-transform:rotate(360deg)}}@keyframes rotate{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}#splash::after,#splash::before{content:'';position:absolute;top:0;left:0;width:100%;height:100%}#splash::before{background:linear-gradient(to right,green,#ff0);-webkit-animation:rotate 2.5s linear infinite;animation:rotate 2.5s linear infinite}#splash::after{background:linear-gradient(to bottom,red,#00f);-webkit-animation:fade 2s infinite alternate,rotate 2.5s linear reverse infinite;animation:fade 2s infinite alternate,rotate 2.5s linear reverse infinite}#splash-spinner{position:absolute;width:100%;height:100%;z-index:1;border-radius:100%;box-sizing:border-box;border-left:.5em solid transparent;border-right:.5em solid transparent;border-bottom:.5em solid rgba(255,255,255,.3);border-top:.5em solid rgba(255,255,255,.3);-webkit-animation:rotate .8s linear infinite;animation:rotate .8s linear infinite}
            .logo-boxed {overflow: hidden;position: relative;}
            .boxed-inner {display: block;height: 80px;overflow: hidden;}
            .boxed-inner img {display: table;vertical-align: middle;margin: 0 auto;width: 100%;height: 100%;padding: 5px;object-fit: contain;}

    </style>
        <?php
            $base_css = base_url('system/cms/modules/users/views/stores/editor/assets/css/').'/';            
            $base_js = base_url('system/cms/modules/users/views/stores/editor/assets/js/').'/';            
            $base_image = base_url('system/cms/modules/users/views/stores/editor/assets/images/').'/';            
        ?>
        <script type="text/javascript">
            var base_path = 'https://'+window.location.host+'/staging/system/cms/modules/users/views/stores/editor/assets/images/';
        </script>
        <link rel="stylesheet" href="<?php echo $base_css; ?>main.css?v14">
    ...
    <body id="editor" ng-app="ImageEditor" ng-strict-di>
        ...
        <div ng-controller="MainController" ng-cloak style="height: 100%">
                ...
                <div id="navigation-bar">
                    <div class="logo-boxed">
                        <div class="boxed-inner">
                            <a href="javascript:void(0)" onclick="go_back()"><img src="
                                <?php echo base_url('/system/cms/themes/storeshere/img/logo.png'); ?>"
                             alt="STORESHERE"></a>
                        </div>
                    </div>
                    <div data-activates="" class="nav-item" onclick="go_back()">
                        <i class="mdi mdi-arrow-back"></i>
                        <div class="title pull-up">Return</div>
                    </div>
                    ...
                    <section id="drawing" class="tab" data-index="3" ng-controller="DrawingController">
                        ...
                        <div id="brushes">
                            <div ng-repeat="brush in drawing.availableBrushes" ng-class="{ active: drawing.activeBrushName == brush }" class="brush" ng-click="changeBrush(brush, $event)">
                                <img title="{{ brush }}" class="img-responsive" ng-src="<?php echo $base_image; ?>brushes/{{brush}}.png"/>
                            </div>
                        </div>
                        ...
                        <div class="filters-list row" ed-pretty-scrollbar ed-scroll-axis="y" ed-scroll-theme="light">
                            <figure ng-class="{ applied: filters.filterAlreadyApplied(filter.name) }" ng-repeat="filter in filters.all" ng-click="filters.applyFilter(filter)" class="filter col-sm-6">
                                <div class="filter-image">
                                    <img ng-src="<?php echo $base_image; ?>filters/{{ filter.name.toLowerCase() }}.png" class="img-responsive md-whiteframe-z1"/>
                            ...
                            <section ng-repeat="category in categories" class="sticker-category-container">
                                ...
                                <div class="category-stickers" ng-class="{ 'open animated slideInDown': activeCategory === category.name, 'dark-bg': category.darkbg }">
                                    <div ng-repeat="doodle in category.items track by $index" ng-click="addToCanvas(category, $index+1, $event)" class="sticker">
                                        <img class="img-responsive" data-src="<?php echo $base_image; ?>stickers/{{category.name}}/{{$index+1}}.{{ category.type }}"/>
                                    </div>
                                </div>
                            </section>
                        </div>
            ...
            <script src="<?php echo $base_js; ?>scripts.min.js?v14"></script>            
            ...
            <script type="application/ng-template" id="gradient-sheet-template">
                <md-bottom-sheet class="bottom-sheet gradients-sheet">
                    <div class="items-list" ed-pretty-scrollbar>
                        <div ng-repeat="g in shapes.gradients" ng-style="{background: 'url(https:\/\/www.storeshere.com/staging/system/cms/modules/users/views/stores/editor/assets/images/gradients/'+($index+1)+'.png)'}" ng-click="shapes.fillWithGradient($index+1)" class="item md-whiteframe-z1"></div>
                    </div>
                </md-bottom-sheet>
            </script>
            ...
            <script type="application/ng-template" id="image-sheet-template">
                <md-bottom-sheet class="bottom-sheet images-sheet">
                    ...
                    <div class="items-list" ed-pretty-scrollbar>
                        <div ng-repeat="t in shapes.textures track by $index" ng-style="{background: 'url(https:\/\/www.storeshere.com/staging/system/cms/modules/users/views/stores/editor/assets/images/textures/'+$index+'.png)'}" ng-click="shapes.fillWithImage('assets/images/textures/'+$index+'.png')" class="item md-whiteframe-z1"></div>
                    </div>
                </md-bottom-sheet>
            </script>
            ...
            <script type="application/ng-template" id="save-image-dialog">
                <md-dialog class="upload-file-dialog save-dialog">
                    ...
                    <md-radio-group>
                        <input type='radio' ng-model="imageType" value="png" checked="true" style="display:none;"> 
                    </md-radio-group>
            ...
            <script>
                function go_back() {
                    if(window.bit != 1){
                        let x = confirm("You have unsaved changes you are sure you want to go back");
                        if(x){
							window.location.href='<?php echo base_url('sendPhotos'); ?>/<?php echo $fd; ?>';
                        }
                    }
                    else{
                        window.location.href='<?php echo base_url('sendPhotos'); ?>/<?php echo $fd; ?>';
