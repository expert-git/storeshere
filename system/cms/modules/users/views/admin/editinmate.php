		...
		<div class="col-md-4 col-sm-4 col-xs-12">
            <div class="content-widget">
                <div class="form-title">
                    <span class="showDiv" >Admin Edit Inmate</span>
                </div>
		...
		<div class="col-md-8 col-sm-8 col-xs-12">
			<div class="components">
				<div class="signup-title">
					<h1>						
						Edit Inmate details - Admin
					</h1>
				</div>				
				<?php echo form_open('users/admin/updateInmate', array('id' => 'editInmatesForm','class'=>'signup horizontal-form')) ?>			       		
			            <div class="spacer10"></div>
			            <div class="groups">
			                <div class="input-group">
			                    <label>Inmate Name (anombre del Reciouso)<font style="color:red;">*</font>:</label>
			                    <input type="text" placeholder="" value="<?php echo $inmate['inmates_name']; ?>" name="name" class="inputw310">
			                </div>
			                <div class="input-group">
			                    <label>Booking Number (número de reserva)<font style="color:red;">*</font>:</label>
			                    <input type="text" placeholder="" value="<?php echo $inmate['inmates_booking_no']; ?>" id="bookingId" name="bookingId" class="inputw310">
			                </div>
			                <div class="input-group">
			                    <label>Confirm Booking No. (confirmar número de reserva)<font style="color:red;">*</font>:</label>
			                    <input type="text" placeholder="" value="<?php echo $inmate['inmates_booking_no']; ?>" name="c_bookingId" class="inputw310">
			                </div>
			                <div class="input-group">
			                    ...
			                    <select id="facility" name="facility" class="inputw310 facilityList">
			                        ...
			                        <?php if(!empty($facility)) :?>
			                            <?php foreach($facility as $k => $v) :?>
			                                 <option <?php if($inmate['facility_id'] == $v['id']){ ?> selected="selected" <?php } ?> value="<?php echo $v['id']?>">
			                                    <?php echo $v['name'];?>
			                                 </option>
			                            <?php endforeach; ?> 
			                        <?php endif; ?>    
			                    </select>
			                    <input type="hidden" name="id" value="<?php echo $inmate['inmates_id']; ?>">
			                </div>
			                <div class="input-group">
			                    <label>Verified<font style="color:red;">*</font>:</label>
			                    <!-- <input type="hidden" name="is_verified" value="<?php echo $inmate['is_verified']; ?>" /> -->
			                    <input type="checkbox" placeholder="" value="<?php echo $inmate['is_verified']; ?>" name="is_verified" class="inputw310"
			                    <?php echo (($inmate['is_verified'] == 1)?"checked":"");?>>
			                </div>
			                <div class="input-group">
