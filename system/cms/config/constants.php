...
define('PAYPAL_EMAIL','business.devpatidar1224@gmail.com');
define('PAYPAL_RETURN_URL', $base_url.'paypal_success');
define('PAYPAL_CANCEL_URL',$base_url.'paypal_cancel');
define('PAYPAL_NOTIFY_URL',$base_url.'paypal_notify');
