...
<div id="sortable">
	...
	<div class="one_full">
	    ...
	    <section id="Orders" class="item <?php echo isset($rss_items) ?>">
			
			<?php if(array_key_exists('users', $this->permissions) OR $this->current_user->group == 'admin' OR $this->current_user->group == 'franchise'): ?>
				<div class="content" id="ordersSummary">
	...
	<div class="one_full">
	    ...
	    <section id="PhotoOrders" class="item <?php echo isset($rss_items) ?>">
			
			<?php if(array_key_exists('users', $this->permissions) OR $this->current_user->group == 'admin' OR $this->current_user->group == 'franchise'): ?>
				<div class="content" id="photoSummary">
	...
	$(document).ready(function(){
		$("#ordersSummary").load("<?php echo base_url('admin/order/fund_summary');?>" );//For loading order summary
		$("#photoSummary").load("<?php echo base_url('admin/order/photo_summary');?>" );//For loading photo order summary
	});
	</script>
