...
class Paypal_pro extends Public_Controller
{
	...
	{	
	   // print_r($DataArray); echo "/cms/vendor/paypal/paypal_pro.php SetExpressCheckout rajat"; die;
		...
		print_r($NVPResponseArray); echo "/cms/vendor/paypal/paypal_pro.php rajat"; die;
