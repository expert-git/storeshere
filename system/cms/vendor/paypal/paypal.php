...
$config['APIUsername'] = $config['Sandbox'] ? 'test_data_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '6C6PHVW6ZBJXGK86' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'An5ns1Kso7MWUdW4ErQKJJJ4qi4-AnBaWodTwvQUarkoQSE7Ra9C3c5k' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = 'manojpatidar280@gmail.com';
