...
class Payments_pro extends Public_Controller 
{
	...
	function __construct()
	{
		...
		$config = array(
			...
			'APIVersion' => $this->config->item('APIVersion'),		// API version you'd like to use for your call.  You can set a default version in the class and leave this blank if you want.																// API version you'd like to use for your call.  You can set a default version in the class and leave this blank if you want.
		);
...
// 		print_r($post); echo "cms/vendor/paypal/payments_pro.php"; die;
	...
	function Set_express_checkout($data)
	{
		$config = array(
			...
			'test' => 'sushil',		// API version you'd like to use for your call.  You can set a default version in the class and leave this blank if you want.
		);
// 		print_r($config); echo "cms/vendor/paypal/payments_pro.php rajat"; die;
