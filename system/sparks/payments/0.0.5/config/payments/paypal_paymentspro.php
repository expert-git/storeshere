...
$config['api_username'] = "ron_api1.ronniecase.com";
$config['api_password'] = "QSBLGUG2NRTVBKWE";
$config['api_signature'] = "AFcWxV21C7fd0v3bYYYRCpSSRl31Aw0T6vNKa9NJbatMxzqjMv7TKTqF";
$config['api_endpoint_test'] = "https://api-3t.sandbox.paypal.com/nvp?";
// $config['api_endpoint_production'] = "https://api-3t.paypal.com/nvp";
$config['api_endpoint_production'] = "https://api.paypal.com/nvp?";
